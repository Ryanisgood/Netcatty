...
export const esAiMessages: Messages = {
  ...
  'ai.chat.contextCompacted': 'Contexto compactado',
  ...
  'ai.codebuddy.advancedSection': 'Opciones avanzadas (SDK 0.3.258)',
  'ai.codebuddy.effort': 'Esfuerzo de razonamiento',
  'ai.codebuddy.effort.default': 'Predeterminado',
  'ai.codebuddy.effort.minimal': 'Mínimo',
  'ai.codebuddy.effort.low': 'Bajo',
  'ai.codebuddy.effort.medium': 'Medio',
  'ai.codebuddy.effort.high': 'Alto',
  'ai.codebuddy.effort.xhigh': 'XHigh',
  'ai.codebuddy.effort.max': 'Máximo',
  'ai.codebuddy.effort.hint': 'Controla la profundidad de razonamiento del modelo. Usa Mínimo/Bajo para comandos simples y ahorrar tokens, y Máximo/Alto para diagnósticos complejos.',
  ...
  'ai.externalMcp.client.cursor': 'Otros',
  'ai.externalMcp.cliCommand': 'Comando CLI',
  'ai.externalMcp.configSnippet': 'Fragmento de configuración',
  'ai.externalMcp.universalSetupPrompt': 'Prompt de instalación universal',
  ...
  'ai.externalMcp.claudeAdded': 'Entrada MCP de Claude Code y skill de Netcatty agregados. Reinicia Claude Code o abre una nueva sesión de Claude Code.',
  'ai.externalMcp.grokAdded': 'Entrada MCP de Grok y skill de Netcatty agregados. Reinicia Grok o abre una nueva sesión de Grok.',
  ...
  'ai.externalMcp.cursor.title': 'Otros clientes',
  'ai.externalMcp.cursor.description': 'Copia el prompt de instalación en otro agente de terminal o combina el fragmento MCP con la configuración de su cliente.',
