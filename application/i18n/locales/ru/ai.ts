...
export const ruAiMessages: Messages = {
  ...
  // Public MCP
  'ai.publicMcp.status.unavailable': 'Недоступно',
  'ai.publicMcp.status.disabled': 'Отключено',
  'ai.publicMcp.status.running': 'Работает',
  'ai.publicMcp.status.starting': 'Запуск',
  'ai.publicMcp.status.error': 'Ошибка',
  'ai.publicMcp.status.configured': 'Настроено',
  'ai.publicMcp.status.notConfigured': 'Не настроено',
  'ai.publicMcp.status.checking': 'Проверка',
  ...
  'ai.publicMcp.mode': 'Режим доступа',
  'ai.publicMcp.mode.temporary': 'Временно',
  'ai.publicMcp.mode.persistent': 'Постоянно',
  'ai.publicMcp.mode.description': 'Временный режим безопаснее для разового доступа; постоянный режим держит Public MCP доступным, пока работает Netcatty.',
  'ai.publicMcp.idleTimeout': 'Тайм-аут простоя',
  ...
  'ai.publicMcp.bridgeUnavailable': 'Public MCP bridge недоступен',
  'ai.publicMcp.copy': 'Копировать',
  'ai.publicMcp.copied': 'Скопировано',
  'ai.publicMcp.copyFailed': 'Не удалось скопировать. Скопируйте вручную.',
  'ai.publicMcp.clientConfiguration': 'Настройка клиента',
  'ai.publicMcp.clientConfiguration.description': 'Выберите MCP-клиент для настройки.',
  'ai.publicMcp.addToCodex': 'Добавить в Codex',
  'ai.publicMcp.addToClaude': 'Добавить в Claude Code',
  'ai.publicMcp.codexAdded': 'MCP-запись Codex добавлена. Перезапустите Codex или откройте новую сессию Codex.',
  'ai.publicMcp.claudeAdded': 'MCP-запись Claude Code добавлена. Перезапустите Claude Code или откройте новую сессию Claude Code.',
  'ai.publicMcp.installCodex': 'Установите Codex отдельно, затем нажмите Обновить.',
  'ai.publicMcp.installClaude': 'Установите Claude Code отдельно, затем нажмите Обновить.',
  'ai.publicMcp.conflict.description': 'Запись netcatty-public уже существует, но указывает на другое место. Удалите или измените её вручную.',
  'ai.publicMcp.enableForLauncher': 'Включите Public MCP, чтобы получить рабочий путь launcher.',
