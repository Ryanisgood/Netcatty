...
export const ruAiMessages: Messages = {
  ...
  'ai.codebuddy.advancedSection': 'Расширенные параметры (SDK 0.3.258)',
  'ai.codebuddy.effort': 'Усилие рассуждения',
  'ai.codebuddy.effort.default': 'По умолчанию',
  'ai.codebuddy.effort.minimal': 'Minimal',
  'ai.codebuddy.effort.low': 'Low',
  'ai.codebuddy.effort.medium': 'Medium',
  'ai.codebuddy.effort.high': 'High',
  'ai.codebuddy.effort.xhigh': 'XHigh',
  'ai.codebuddy.effort.max': 'Max',
  'ai.codebuddy.effort.hint': 'Управляет глубиной рассуждения модели. Для простых команд используйте Minimal/Low, чтобы экономить токены, а для сложной диагностики — Max/High.',
  'ai.codebuddy.maxTurns': 'Максимум шагов',
  'ai.codebuddy.maxTurns.hint': 'Ограничивает максимальное число шагов диалога за запрос, предотвращая зацикливание. Оставьте пустым для значения по умолчанию.',
  'ai.codebuddy.maxBudget': 'Максимальный бюджет (USD)',
  'ai.codebuddy.maxBudget.hint': 'Максимальные расходы (USD) за запрос. При превышении выполнение останавливается автоматически. Оставьте пустым, чтобы не ограничивать.',
  'ai.codebuddy.sandbox': 'Режим песочницы',
  'ai.codebuddy.sandbox.hint': 'Выполняет вызовы инструментов в песочнице, ограничивая доступ к файловой системе и сети.',
  'ai.codebuddy.persistSession': 'Сохранение сессии',
  'ai.codebuddy.persistSession.hint': 'Сохраняет на диск собственную историю сессии CodeBuddy, чтобы CodeBuddy мог возобновить её позже. Отключите, чтобы запретить хранение сессии CodeBuddy; Netcatty всё ещё может сохранять историю чата и метаданные внешней сессии. Контрольные точки файлов пропускаются. Требуется CodeBuddy CLI 2.125.1 или новее.',
  'ai.codebuddy.fileCheckpointing': 'Контрольные точки файлов',
  'ai.codebuddy.fileCheckpointing.hint': 'Включает контрольные точки файловых операций, чтобы изменения файлов ИИ можно было откатить.',
  ...
  'ai.externalMcp.client.cursor': 'Другие',
  'ai.externalMcp.cliCommand': 'CLI-команда',
  'ai.externalMcp.configSnippet': 'Фрагмент конфига',
  'ai.externalMcp.universalSetupPrompt': 'Универсальный запрос установки',
  ...
  'ai.externalMcp.claudeAdded': 'Запись MCP для Claude Code и навык Netcatty добавлены. Перезапустите Claude Code или откройте новую сессию.',
  'ai.externalMcp.grokAdded': 'Запись MCP для Grok и навык Netcatty добавлены. Перезапустите Grok или откройте новую сессию.',
  ...
  'ai.externalMcp.cursor.title': 'Другие клиенты',
  'ai.externalMcp.cursor.description': 'Скопируйте запрос установки в другой терминальный агент или добавьте фрагмент MCP в конфигурацию его клиента.',
