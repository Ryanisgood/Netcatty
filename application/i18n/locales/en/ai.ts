...
export const enAiMessages: Messages = {
  ...
  'ai.chat.contextCompacted': 'Context compacted',
  ...
  'ai.providers.headers': 'Custom HTTP Headers',
  'ai.providers.headers.help': 'Optional headers for this provider. Values are hidden and encrypted when saved.',
  'ai.providers.headers.name': 'Header name',
  ...
  'ai.codebuddy.advancedSection': 'Advanced options (SDK 0.3.258)',
  ...
  'ai.codebuddy.effort.hint': 'Controls model reasoning depth. Use Minimal/Low for simple commands to save tokens, Max/High for complex diagnostics.',
  ...
  'ai.externalMcp.client.cursor': 'Other',
  'ai.externalMcp.cliCommand': 'CLI command',
  'ai.externalMcp.configSnippet': 'Config snippet',
  'ai.externalMcp.universalSetupPrompt': 'Universal setup prompt',
  ...
  'ai.externalMcp.claudeAdded': 'Claude Code MCP entry and Netcatty skill added. Restart Claude Code or open a new Claude Code session.',
  'ai.externalMcp.grokAdded': 'Grok MCP entry and Netcatty skill added. Restart Grok or open a new Grok session.',
  ...
  'ai.externalMcp.cursor.title': 'Other clients',
  'ai.externalMcp.cursor.description': 'Copy the setup prompt into another terminal agent, or merge the MCP snippet into its client configuration.',
