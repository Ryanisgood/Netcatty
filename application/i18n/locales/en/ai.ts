...
export const enAiMessages: Messages = {
  ...
  'ai.publicMcp.status.disabled': 'Disabled',
  'ai.publicMcp.status.running': 'Running',
  'ai.publicMcp.status.starting': 'Starting',
  'ai.publicMcp.status.error': 'Error',
  'ai.publicMcp.status.configured': 'Configured',
  'ai.publicMcp.status.notConfigured': 'Not configured',
  'ai.publicMcp.status.checking': 'Checking',
  ...
  'ai.publicMcp.mode': 'Availability mode',
  'ai.publicMcp.mode.temporary': 'Temporary',
  'ai.publicMcp.mode.persistent': 'Always on',
  'ai.publicMcp.mode.description': 'Temporary mode is safer for ad-hoc use; always-on mode keeps Public MCP available while Netcatty is running.',
  'ai.publicMcp.idleTimeout': 'Idle timeout',
  ...
  'ai.publicMcp.bridgeUnavailable': 'Public MCP bridge unavailable',
  'ai.publicMcp.copy': 'Copy',
  'ai.publicMcp.copied': 'Copied',
  'ai.publicMcp.copyFailed': 'Copy failed. Try copying manually.',
  'ai.publicMcp.clientConfiguration': 'Client configuration',
  'ai.publicMcp.clientConfiguration.description': 'Choose one MCP client to configure.',
  'ai.publicMcp.addToCodex': 'Add to Codex',
  'ai.publicMcp.addToClaude': 'Add to Claude Code',
  'ai.publicMcp.codexAdded': 'Codex MCP entry added. Restart Codex or open a new Codex session.',
  'ai.publicMcp.claudeAdded': 'Claude Code MCP entry added. Restart Claude Code or open a new Claude Code session.',
  'ai.publicMcp.installCodex': 'Install Codex separately, then click Refresh.',
  'ai.publicMcp.installClaude': 'Install Claude Code separately, then click Refresh.',
  'ai.publicMcp.conflict.description': 'A netcatty-public entry already exists and points elsewhere. Remove or edit it manually.',
  'ai.publicMcp.enableForLauncher': 'Enable Public MCP to get a usable launcher path.',
  ...
  'topTabs.publicMcp.enable': 'Enable Public MCP',
  'topTabs.publicMcp.disable': 'Disable Public MCP',
