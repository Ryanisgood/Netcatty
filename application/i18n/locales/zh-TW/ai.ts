...
export const zhTWAiMessages: Messages = {
  ...
  'ai.chat.contextCompacted': '上下文已壓縮',
  ...
  'ai.providers.openaiApi.help': '預設 Chat Completions，相容大多數 OpenAI 相容介面。部分中繼站在 Responses（/v1/responses）上快取命中率較高。',
  ...
  'ai.codex.description': '介接 OpenAI Codex。可以在這裡登入 ChatGPT，也可以在設定裡啟用相容 OpenAI 的 API Key 和自訂介面位址。',
  ...
  'ai.cursor.path': '執行環境：',
  'ai.cursor.notFoundHint': '填寫 API Key，或切換到 CLI 登入模式。',
  ...
  'ai.codebuddy.advancedSection': '進階選項（SDK 0.3.258）',
  ...
  'ai.codebuddy.effort.hint': '控制模型推理深度。簡單命令用 Minimal/Low 節省 token，複雜診斷用 Max/High。',
  ...
  'ai.externalMcp.permissionMode.hint': '與「設定 → AI → 安全」為同一項。自動：Netcatty 寫入操作不再彈本應用核准；確認：每次詢問。外部用戶端（Codex / Claude / Grok）仍可能有自己的工具核准介面。',
  ...
  'ai.externalMcp.client.cursor': '其他用戶端',
  'ai.externalMcp.cliCommand': 'CLI 命令',
  'ai.externalMcp.configSnippet': '設定片段',
  'ai.externalMcp.universalSetupPrompt': '通用安裝提示詞',
  ...
  'ai.externalMcp.claudeAdded': '已新增 Claude Code MCP 項目和 Netcatty Skill。請重新啟動 Claude Code 或開啟新工作階段。',
  'ai.externalMcp.grokAdded': '已新增 Grok MCP 項目和 Netcatty Skill。請重新啟動 Grok 或開啟新工作階段。',
  ...
  'ai.externalMcp.cursor.title': '其他用戶端',
  'ai.externalMcp.cursor.description': '將安裝提示詞複製到其他終端 Agent，或把 MCP 片段合併到對應用戶端設定。',
  ...
  'ai.safety.permissionMode.description': '控制 AI 透過 Netcatty 存取終端工作階段的方式。觀察者模式會阻止經由 Netcatty 的寫操作；外部 Agent CLI 可能仍有自己的本機工具和核准流程。',
