...
export const zhCNAiMessages: Messages = {
  ...
  'ai.chat.contextCompacted': '上下文已压缩',
  ...
  'ai.providers.headers': '自定义 HTTP 请求头',
  'ai.providers.headers.help': '为此服务添加可选请求头。内容会隐藏显示并在保存时加密。',
  'ai.providers.headers.name': '请求头名称',
  ...
  'ai.codebuddy.advancedSection': '高级选项（SDK 0.3.258）',
  ...
  'ai.codebuddy.effort.hint': '控制模型推理深度。简单命令用 Minimal/Low 节省 token，复杂诊断用 Max/High。',
  ...
  'ai.externalMcp.client.cursor': '其他客户端',
  'ai.externalMcp.cliCommand': 'CLI 命令',
  'ai.externalMcp.configSnippet': '配置片段',
  'ai.externalMcp.universalSetupPrompt': '通用安装提示词',
  ...
  'ai.externalMcp.claudeAdded': '已添加 Claude Code MCP 条目和 Netcatty Skill。请重启 Claude Code 或打开新会话。',
  'ai.externalMcp.grokAdded': '已添加 Grok MCP 条目和 Netcatty Skill。请重启 Grok 或打开新会话。',
  ...
  'ai.externalMcp.cursor.title': '其他客户端',
  'ai.externalMcp.cursor.description': '将安装提示词复制到其他终端 Agent，或把 MCP 片段合并到对应客户端配置。',
