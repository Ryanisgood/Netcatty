...
export const zhCNAiMessages: Messages = {
  ...
  'ai.publicMcp.status.disabled': '已禁用',
  'ai.publicMcp.status.running': '运行中',
  'ai.publicMcp.status.starting': '启动中',
  'ai.publicMcp.status.error': '错误',
  'ai.publicMcp.status.configured': '已配置',
  'ai.publicMcp.status.notConfigured': '未配置',
  'ai.publicMcp.status.checking': '检查中',
  ...
  'ai.publicMcp.mode': '可用模式',
  'ai.publicMcp.mode.temporary': '临时开启',
  'ai.publicMcp.mode.persistent': '常驻开启',
  'ai.publicMcp.mode.description': '临时开启更适合临时授权；常驻开启会在 Netcatty 运行期间持续提供 Public MCP。',
  'ai.publicMcp.idleTimeout': '空闲超时',
  ...
  'ai.publicMcp.bridgeUnavailable': 'Public MCP bridge 不可用',
  'ai.publicMcp.copy': '复制',
  'ai.publicMcp.copied': '已复制',
  'ai.publicMcp.copyFailed': '复制失败，请手动复制。',
  'ai.publicMcp.clientConfiguration': '客户端配置',
  'ai.publicMcp.clientConfiguration.description': '选择一个要配置的 MCP 客户端。',
  'ai.publicMcp.addToCodex': '添加到 Codex',
  'ai.publicMcp.addToClaude': '添加到 Claude Code',
  'ai.publicMcp.codexAdded': '已添加 Codex MCP 条目。请重启 Codex 或打开新的 Codex 会话。',
  'ai.publicMcp.claudeAdded': '已添加 Claude Code MCP 条目。请重启 Claude Code 或打开新的 Claude Code 会话。',
  'ai.publicMcp.installCodex': '请先单独安装 Codex，然后点击刷新。',
  'ai.publicMcp.installClaude': '请先单独安装 Claude Code，然后点击刷新。',
  'ai.publicMcp.conflict.description': '已存在名为 netcatty-public 的条目，但它指向其他位置。请手动移除或编辑该条目。',
  'ai.publicMcp.enableForLauncher': '启用 Public MCP 后才能获取可用的 launcher 路径。',
  ...
  'topTabs.publicMcp.enable': '启用 Public MCP',
  'topTabs.publicMcp.disable': '禁用 Public MCP',
